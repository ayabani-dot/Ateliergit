...
int spawnPointX;
 int spawnPointY;
 int range; int leftcounter;
 int rightcounter;
 int upcounter; int downcounter;
 direction d;
 SDL_Rect pos; SDL_Surface* upImage[4]; SDL_Surface* downImage[4]; 
SDL_Surface* rightImage[4]; 
SDL_Surface* leftImage[4];
